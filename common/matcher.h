...
struct cli_matcher {
    ...
    /* Bytecode Tracker */
    uint32_t linked_bcs;
     struct cli_ac_patt **gpu_patt_lookup;
     uint8_t *gpu_is_simple;
    ...
    struct gpu_flattened_dfa *gpu_flat_dfa; 
#ifdef USE_MPOOL
    mpool_t *mempool;
#else
    void *_padding_mempool;
...
#ifdef HAVE_OPENCL
struct gpu_flattened_dfa;  /* Forward declaration */
#endif
